...
_This article reports on a project, integrating Stencila and Binder, which started at the eLife Innovation Sprint 2018. It has been cross-posted on multiple blogs ([eLife Labs](https://elifesciences.org/labs/d42fe2b9/integrating-binder-and-stencila-the-building-blocks-to-increased-open-communication-and-transparency), [Stencila](https://stenci.la/blog/2018-11-20-stencila-binder/), [Jupyter](https://blog.jupyter.org/elife-sprint-integrating-stencila-and-binder-18834e9ad584)). We welcome comments and feedback on any of them!_
...
The online service [mybinder.org](https://mybinder.org/) is the most prominent example for a platform based on the Binder project, a part of [Project Jupyter](https://jupyter.org/).
